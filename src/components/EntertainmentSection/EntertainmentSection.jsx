...
// import { FiStar } from "react-icons/fi"; // Make sure to import this
...
//       try {
//         setLoading(true);
//         const res = await axios.get("http://localhost:5000/articles"); // Your backend route
//         const allArticles = res.data;

//         // Filter entertainment articles after fetching
...
//         const hasPremiumToken = !!user?.premiumTaken;
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch all articles
        const articlesRes = await axios.get("http://localhost:5000/articles");
