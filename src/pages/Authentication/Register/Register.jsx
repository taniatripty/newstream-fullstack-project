...
//   const { Googlelogin, user, createuser, upadeteuser } = useAuth();
...
//           position: "top-end",
//           icon: "success",
//           title: "social login successfull",
...
//               <p className="text-red-600"> lenght must 6 character</p>
//             )}
//             {errors.password?.type === "pattern" && (
//               <p className="text-red-600">
//                 {" "}
//                 must one capital, small letter and one digit
//               </p>
//             )}
//           </div>
