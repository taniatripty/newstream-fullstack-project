...
//   const { user, isSubscribed } = useAuth(); // assuming subscription status
...
//   // Fetch articles with backend filtering
//   const {
//     data: articles = [],
//     refetch,
//     isLoading,
...
//       return axiosSecure
//         .get("/article/approve", { params })
//         .then((r) => r.data);
//     },
//   });

//   // Refresh results when filters change
//   //   useEffect(() => refetch(), [searchTitle, publisherFilter, tagsFilter]);
...
//   if (isLoading || pLoading || tLoading)
...
//           const canView = !isPremium || isSubscribed;
//           return (
//             <div
//               key={article._id}
...
//                   }`}
//                 >
//                   {(!isPremium ) ? "Details" : "Subscribe to View"}
//                 </button>
//               </div>
//             </div>
//           );
